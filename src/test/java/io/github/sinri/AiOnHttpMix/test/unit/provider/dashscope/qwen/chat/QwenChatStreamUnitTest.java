...
public class QwenChatStreamUnitTest extends AbstractQwenChatModelUnitTest {
    ...
    public void test2() {
        ...
        async(() -> {
            QwenRequest request = QwenRequest.create()
                                             .input(x -> x
                                                     .addMessage(
                                                             QwenMessageInChatRequest.createAsUserInRequest("歼10CE和阵风哪个厉害啊")
                                                     ))
                                             .parameters(x -> x
                                                     .enableThinking(true)
        ...
        async(() -> {
            QwenRequest request = QwenRequest
                    ...
                    .input(x -> x
                            ...
                            .addUserChatMessage("2025年5月3日，杭州的天气是什么")
                    )
                    .parameters(x -> x
                            .stream(true)
                            .incrementalOutput(true)
