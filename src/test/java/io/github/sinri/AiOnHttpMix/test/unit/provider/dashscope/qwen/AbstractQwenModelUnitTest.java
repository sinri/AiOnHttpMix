 ...
 */
public abstract class AbstractQwenModelUnitTest extends AbstractModelUnitTest<QwenModelSeries> {
    private final QwenModelSeries qwenPlusLatest;
    private final QwenKit qwenKit;
    public AbstractQwenModelUnitTest() {
        qwenPlusLatest = QwenModelSeries.model(QwenModelSeries.MODEL_NAME_OF_QWEN_PLUS_LATEST);
        qwenKit =new QwenKit();
    }
    ...
    @Override
    protected QwenModelSeries getModel() {
