...
public interface MixVisionSyncFCMixin extends MixVisionCoreMixin {
    default Future<Void> toTestSync(SupportedModelEnum supportedModelEnum) {
        ...
        MixChatRequest mixChatRequest = MixChatRequest.create()
                                                      ...
                                                      .addMessage(MixChatMessage.create()
                                                                                ...
                                                                                .setVisionContent(List.of(
                                                                                        ...
                                                                                        MixChatVisionContentElement.create()
                                                                                                                   .setText("这个照片的所在地点，在2010年8月1日有没有下雨")
                                                                                ))
                                                      )
        ...
        return Future.succeededFuture()
                     .compose(round1 -> {
                         return getMixChatKit().chat(mixChatRequest);
                     })
                     .compose(resp1 -> {
                     ...
                     .compose(toolCallOutput -> {
                         ...
                         mixChatRequest.addMessage(MixChatMessage.create()
                                                                 .setRole("assistant")
