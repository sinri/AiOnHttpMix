...
import io.github.sinri.AiOnHttpMix.provider.azure.openai.chatgpt.response.sync.ChatGPTResponseChoice;
import io.github.sinri.AiOnHttpMix.provider.azure.openai.chatgpt.tool.ChatGPTFunctionToolDefinition;
...
public class ChatGptSyncUnitTest extends AbstractChatGptKitUnitTest {
    @Test
    public void test1() {
        async(() -> {
            ChatGPTRequest request = ChatGPTRequest
                    .create()
                    .addMessage(ChatGPTMessageInRequest.createAsSystem("你是日本战国史学家", null))
                    .addMessage(ChatGPTMessageInRequest.createAsUser("筑波山周边是哪些大名的势力范围", null));
            return getKit()
                    .chat(
                            getServiceAdapter(),
                            ChatModel.chatgpt4o,
                    ...
                    .compose(resp -> {
                        ...
                        ChatGPTResponseChoice choice = resp.getChoices().get(0);
                        ChatGPTMessageInResponse message = choice.getMessage();
    ...
    public void test2() {
        async(() -> {
            ChatGPTRequest request = ChatGPTRequest
                    ...
                    .addTool(x -> x
                            .type("function")
                            .function(new ChatGPTFunctionToolDefinition()
            ...
            AtomicReference<ChatGPTMessageInResponse> msgRef=new AtomicReference<>();
            ...
            return getKit()
                    ...
                    .compose(resp -> {
                        ...
                        List<ChatGPTToolCall> toolCalls = message.getToolCalls();
                        Assert.assertFalse(toolCalls.isEmpty());
                        ChatGPTToolCall toolCall = toolCalls.get(0);
