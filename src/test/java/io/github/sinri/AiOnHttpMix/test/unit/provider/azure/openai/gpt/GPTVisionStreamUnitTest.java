...
public class GPTVisionStreamUnitTest extends AbstractGptUnitTest {
    ...
    public void test1() {
        ...
        async(() -> {
            String imageUrl = "https://mmbiz.qpic.cn/sz_mmbiz_jpg/MWpJc0Ao1ic034EWO3nPkVh12H6Y44vjekM7JUBOyYKViartbR9TbUvB4KgxpXJ7O8G7HdDHpiaibATCqLHmJe6IPA/640";
            ...
            AigcMix.getVerboseLogger().info("request", request.toJsonObject());
            return getKit()
                    .chatStream(
                            getModel(),
                            request,
