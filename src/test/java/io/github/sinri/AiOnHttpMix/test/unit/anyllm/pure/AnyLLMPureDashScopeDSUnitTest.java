...
public class AnyLLMPureDashScopeDSUnitTest extends AbstractAnyLLMPureUnitTest<DashscopeServiceMeta> {
    @Override
    ...
    public AnyLLMKit createAnyLLMKit() {
        return new AnyLLMKit().useDashScope(generateServiceMeta(), SupportedModel.DeepSeekChatOnDashScope);
    }
