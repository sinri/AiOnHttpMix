...
public interface OpenAIEmbeddingResponse extends UnmodifiableJsonifiableEntity {
    static OpenAIEmbeddingResponse wrap(JsonObject json) {
        return new OpenAIEmbeddingResponseImpl(json);
    }
