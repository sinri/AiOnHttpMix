...
public interface VolcesChatResponseChoice extends UnmodifiableJsonifiableEntity {
    static VolcesChatResponseChoice wrap(JsonObject jsonObject) {
        return new VolcesChatResponseChoiceImpl(jsonObject);
    }
    /**
     ...
     * @return 模型输出的消息内容
     */
    default VolcesChatResponseMessage getMessage() {
