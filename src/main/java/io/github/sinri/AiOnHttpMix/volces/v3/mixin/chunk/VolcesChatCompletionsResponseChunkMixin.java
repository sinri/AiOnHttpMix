package io.github.sinri.AiOnHttpMix.volces.v3.mixin.chunk;

import io.github.sinri.AiOnHttpMix.volces.v3.VolcesKit;
import io.github.sinri.AiOnHttpMix.volces.v3.impl.ChatCompletionsResponseChunkImpl;
import io.github.sinri.AiOnHttpMix.volces.v3.mixin.tool.SharedFunctionCall;
...
public interface VolcesChatCompletionsResponseChunkMixin extends UnmodifiableJsonifiableEntity {
    /**
    ...
    default VolcesKit.Usage getUsage() {
        ...
        return VolcesKit.Usage.wrap(entries);
    }
    ...
    interface StreamChoice extends UnmodifiableJsonifiableEntity {
        static StreamChoice wrap(JsonObject object) {
            return new ChatCompletionsResponseChunkImpl.StreamChoiceImpl(object);
        }
    ...
    interface ChoiceDelta extends UnmodifiableJsonifiableEntity {
        static ChoiceDelta wrap(JsonObject object) {
            return new ChatCompletionsResponseChunkImpl.ChoiceDeltaImpl(object);
        }
    ...
    interface ChoiceDeltaToolCall extends UnmodifiableJsonifiableEntity {
        static ChoiceDeltaToolCall wrap(JsonObject object) {
            return new ChatCompletionsResponseChunkImpl.ChoiceDeltaToolCallImpl(object);
        }
    ...
    interface FunctionCallChunk extends SharedFunctionCall {
        static FunctionCallChunk wrap(JsonObject object) {
            return new ChatCompletionsResponseChunkImpl.FunctionCallChunkImpl(object);
        }
    }
}
