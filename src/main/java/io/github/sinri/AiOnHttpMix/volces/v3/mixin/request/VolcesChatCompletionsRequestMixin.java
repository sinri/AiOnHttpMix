...
import io.github.sinri.AiOnHttpMix.volces.v3.impl.ChatCompletionsRequestImpl;
import io.github.sinri.keel.core.SelfInterface;
import io.github.sinri.keel.core.json.JsonifiableEntity;
import io.vertx.core.json.JsonArray;

public interface VolcesChatCompletionsRequestMixin<E> extends JsonifiableEntity<E>, SelfInterface<E> {
    /**
     * @param model 以 endpoint_id 索引对应的模型接入点。
     */
    default E setModel(String model) {
        this.toJsonObject().put("model", model);
        return getImplementation();
    }

    default E addMessage(VolcesKit.MessageParam message) {
     ...
     */
    default E setFrequencyPenalty(double frequency_penalty) {
    ...
    default E setStreamOptions(StreamOptionsParam streamOptions) {
    ...
    interface StreamOptionsParam extends JsonifiableEntity<StreamOptionsParam> {
        static StreamOptionsParam create() {
            return new ChatCompletionsRequestImpl.StreamOptionsParamImpl();
        }
     ...
     */
    default E setTemperature(double temperature) {
     ...
     */
    default E setTopP(double top_p) {
     ...
     */
    default E addTool(VolcesKit.ToolParam toolParam) {
