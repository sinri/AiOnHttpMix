...
public interface DoubaoRequest extends JsonifiableEntity<DoubaoRequest> {
    ...
    default DoubaoRequest thinking(ThinkingOptions thinkingOptions) {
        return this.write("thinking", thinkingOptions.toJsonObject());
    }
    ...
    default DoubaoRequest streamOptions(StreamOptions streamOptions) {
        return this.write("stream_options", streamOptions.toJsonObject());
    }
    ...
    default DoubaoRequest serviceTier(String service_tier) {
        return write("service_tier", service_tier);
    }

    default String serviceTier() {
    ...
    default DoubaoRequest stop(List<String> stop) {
        return write("stop", new JsonArray(stop));
    }
    ...
    default DoubaoRequest responseFormat(ResponseFormatOptions responseFormatOptions) {
        return write("response_format", responseFormatOptions.toJsonObject());
    }
