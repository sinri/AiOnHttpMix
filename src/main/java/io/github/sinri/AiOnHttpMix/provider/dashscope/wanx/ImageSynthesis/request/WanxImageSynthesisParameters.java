...
public interface WanxImageSynthesisParameters extends JsonifiableEntity<WanxImageSynthesisParameters> {
    static WanxImageSynthesisParameters wrap(JsonObject x) {
        return new WanxImageSynthesisParametersImpl().reloadDataFromJsonObject(x);
    }
    ...
    default WanxImageSynthesisParameters setStyle(Style style) {
        this.toJsonObject().put("style", style.styleCode);
        return this;
    }
    ...
    default WanxImageSynthesisParameters setRefStrength(float refStrength) {
        ...
        this.toJsonObject().put("ref_strength", refStrength);
        return this;
    }

    default RefMode getRefMode() {
    ...
    default WanxImageSynthesisParameters setRefMode(RefMode refMode) {
        this.toJsonObject().put("ref_mode", refMode.name());
        return this;
    }
