...
public interface QwenRequestInput extends JsonifiableEntity<QwenRequestInput> {
    ...
    default QwenRequestInput addSystemMessage(String content) {
        return addMessage(QwenMessageInRequest.createAsSystemInRequest(content));
    }

    default QwenRequestInput addUserMessage(String content) {
        return addMessage(QwenMessageInRequest.createAsUserInRequest(content));
    }

    default QwenRequestInput addAssistantMessage(String content) {
        return addMessage(QwenMessageInRequest.createAsAssistantInRequest(content));
    }
    ...
    default QwenRequestInput addToolOutputMessage(String content, String toolCallId) {
        return addMessage(QwenMessageInRequest.createAsToolOutputInRequest(content, toolCallId));
    }
