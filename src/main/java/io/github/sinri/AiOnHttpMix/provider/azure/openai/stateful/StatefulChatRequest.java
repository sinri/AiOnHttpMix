 ...
 * @since 2.0.1
 */
public interface StatefulChatRequest extends JsonifiableEntity<StatefulChatRequest> {
    ...
    default StatefulChatRequest setBackground(Boolean background) {
        this.write("background", background);
        return this;
    }

    default JsonArray getInclude() {
    ...
    default StatefulChatRequest setInstructions(String instructions) {
        this.write("instructions", instructions);
        return this;
    }
    ...
    default StatefulChatRequest setMaxOutputTokens(Integer maxOutputTokens) {
        this.write("max_output_tokens", maxOutputTokens);
        return this;
    }

    default JsonObject getMetadata() {
    ...
    default StatefulChatRequest setParallelToolCalls(Boolean parallelToolCalls) {
        this.write("parallel_tool_calls", parallelToolCalls);
        return this;
    }

    default String getPreviousResponseId() {
    ...
    default StatefulChatRequest setPreviousResponseId(String previousResponseId) {
        this.write("previous_response_id", previousResponseId);
        return this;
    }

    default JsonObject getReasoning() {
    ...
    default StatefulChatRequest setReasoning(JsonObject reasoning) {
        this.write("reasoning", reasoning);
        return this;
    }
    ...
    default StatefulChatRequest setStore(Boolean store) {
        this.write("store", store);
        return this;
    }

    default Boolean getStream() {
    ...
    default StatefulChatRequest setTemperature(Float temperature) {
        this.write("temperature", temperature);
        return this;
    }

    default JsonObject getText() {
    ...
    default JsonObject getToolChoice() {
    ...
    default StatefulChatRequest setToolChoice(JsonObject toolChoice) {
        this.write("tool_choice", toolChoice);
        return this;
    }

    default JsonArray getTools() {
    ...
    default StatefulChatRequest setTopP(Float topP) {
        this.write("top_p", topP);
        return this;
    }

    default String getTruncation() {
    ...
    default StatefulChatRequest setTruncation(String truncation) {
        this.write("truncation", truncation);
        return this;
    }
