...
interface QwenRequestParametersCore<E> extends JsonifiableEntity<E> {
    ...
    default E stream(boolean stream) {
        return this.write("stream", stream);
    }
    ...
    default E incrementalOutput(boolean incremental_output) {
        return this.write("incremental_output", incremental_output);
    }

    default Boolean incrementalOutput() {
    ...
    default E presencePenalty(float presencePenalty) {
        return this.write("presence_penalty", presencePenalty);
    }
    ...
    default E repetitionPenalty(float repetition_penalty) {
        return this.write("repetition_penalty", repetition_penalty);
    }

    /**
     * 获取 repetition_penalty 参数。
     */
    default Float repetitionPenalty() {
    ...
    default E maxTokens(int maxTokens) {
        this.write("max_tokens", maxTokens);
        return this.getImplementation();
    }
     ...
     * 返回内容的格式。
     */
    default JsonObject responseFormat() {
    ...
    default E resultFormat(String result_format) {
        return this.write("result_format", result_format);
    }
