...
public interface GPTMessageInRequest extends GPTMessage {
    static GPTMessageInRequest create() {
     ...
     *                role.
     */
    static GPTMessageInRequest createAsSystem(String content, @Nullable String name) {
     ...
     *                role.
     */
    static GPTMessageInRequest createAsUser(String content, @Nullable String name) {
        var j = new JsonObject()
                .put("role", "user")
                .put("content", content);
        if (name != null) {
     ...
     */
    static GPTMessageInRequest createAsAssistant(
            String content,
     ...
     */
    static GPTMessageInRequest createAsToolOutput(@Nullable String content, String tool_call_id) {
        var j = new JsonObject();
        j.put("role", "tool");
        j.put("content", content);
    ...
    static GPTMessageInRequest wrap(JsonObject jsonObject) {
