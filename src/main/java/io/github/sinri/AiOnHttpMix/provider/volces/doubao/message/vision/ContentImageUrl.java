...
public interface ContentImageUrl extends JsonifiableEntity<ContentImageUrl> {
     ...
     */
    default ContentImageUrl setUrl(String url) {
    ...
    default ImagePixelLimit getImagePixelLimit() {
     ...
     */
    default ContentImageUrl setImagePixelLimit(ImagePixelLimit imagePixelLimit) {
        return write("image_pixel_limit", imagePixelLimit == null ? null : imagePixelLimit.toJsonObject());
    }

    interface ImagePixelLimit extends JsonifiableEntity<ImagePixelLimit> {
