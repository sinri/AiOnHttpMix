...
import io.github.sinri.AiOnHttpMix.provider.azure.openai.chatgpt.message.ChatGPTMessage;
import io.github.sinri.AiOnHttpMix.provider.azure.openai.chatgpt.message.ChatGPTMessageInRequest;
...
import io.github.sinri.AiOnHttpMix.provider.azure.openai.chatgpt.tool.ChatGPTToolDefinition;
...
public interface ChatGPTRequest extends JsonifiableEntity<ChatGPTRequest> {

    static ChatGPTRequest create() {
        return new ChatGPTRequestImpl();
    }

    static ChatGPTRequest wrap(JsonObject jsonObject) {
        return new ChatGPTRequestImpl(jsonObject);
    }
     ...
     */
    default ChatGPTRequest stream(boolean stream) {
     ...
     */
    default ChatGPTRequest temperature(float temperature) {
     ...
     */
    default ChatGPTRequest logprobs(boolean logprobs) {
     ...
     */
    default ChatGPTRequest topLogprobs(int top_logprobs) {
     ...
     * @param n default 1
     */
    default ChatGPTRequest n(int n) {
        return write("n", n);
    }
     ...
     */
    default ChatGPTRequest parallelToolCalls(boolean parallel_tool_calls) {
     ...
     */
    default ChatGPTRequest responseFormat(ChatGPTResponseFormat responseFormat) {
        return write("response_format", responseFormat.toJsonObject());
    }

    default ChatGPTResponseFormat responseFormat() {
        JsonObject x = readJsonObject("response_format");
        if (x == null) {
            x = new JsonObject();
        }
        return ChatGPTResponseFormat.wrap(x);
    }
     ...
     */
    default ChatGPTRequest seed(Integer seed) {
     ...
     */
    default ChatGPTRequest addTool(ChatGPTToolDefinition toolDefinition) {
        ensureJsonArray("tools")
                .add(toolDefinition.toJsonObject());
        return this;
    }

    default ChatGPTRequest addTool(Handler<ChatGPTToolDefinition> toolDefinitionHandler) {
        var x = new ChatGPTToolDefinition(new JsonObject());
        toolDefinitionHandler.handle(x);
        return addTool(x);
    }

    default List<ChatGPTToolDefinition> tools() {
        List<JsonObject> tools = readJsonObjectArray("tools");
        if (tools == null)
            return List.of();
        return tools.stream().map(ChatGPTToolDefinition::new).toList();
    }
     ...
     */
    default ChatGPTRequest toolChoiceForFunctionType(String functionName) {
     ...
     *                   calling tools
     */
    default ChatGPTRequest toolChoice(String toolChoice) {
     ...
     *             tokens.
     */
    default ChatGPTRequest stop(String stop) {
     ...
     *                   chat completion.
     */
    default ChatGPTRequest maxTokens(int max_tokens) {
     ...
     *                              tokens.
     */
    default ChatGPTRequest maxCompletionTokens(int max_completion_tokens) {
     ...
     */
    default ChatGPTRequest presencePenalty(float presence_penalty) {
     ...
     */
    default ChatGPTRequest frequencyPenalty(float frequency_penalty) {
     ...
     */
    default ChatGPTRequest logitBias(JsonObject logit_bias) {
     ...
     */
    default ChatGPTRequest user(String user) {
    ...
    default ChatGPTRequest addMessage(ChatGPTMessage message) {
        this.ensureJsonArray("messages")
            .add(message.toJsonObject());
        return this;
    }

    default ChatGPTRequest addSystemMessage(String content) {
        return this.addMessage(ChatGPTMessageInRequest.createAsSystem(content, null));
    }

    default ChatGPTRequest addUserMessage(String content) {
        return this.addMessage(ChatGPTMessageInRequest.createAsUser(content, null));
    }

    default ChatGPTRequest addAssistantMessage(String content) {
        return this.addMessage(ChatGPTMessageInRequest.createAsAssistant(content, null, null));
    }

    default ChatGPTRequest addToolCallMessage(@Nullable String content, List<ChatGPTToolCall> toolCalls) {
        return this.addMessage(ChatGPTMessageInRequest.createAsToolCall(content, toolCalls, null, null));
    }

    default ChatGPTRequest addToolCallMessage(ChatGPTMessageInResponse messageInResponse) {
        return this.addMessage(messageInResponse);
    }

    default ChatGPTRequest addToolOutputMessage(@Nullable String content, String tool_call_id) {
        return this.addMessage(ChatGPTMessageInRequest.createAsToolOutput(content, tool_call_id));
    }

    /**
     * A list of messages comprising the conversation so far.
     */
    default List<ChatGPTMessageInRequest> messages() {
        List<JsonObject> messages = readJsonObjectArray("messages");
        if (messages == null)
            return List.of();
        return messages.stream().map(ChatGPTMessageInRequest::wrap).toList();
    }
