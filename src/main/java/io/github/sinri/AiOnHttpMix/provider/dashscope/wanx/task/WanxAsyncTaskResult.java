package io.github.sinri.AiOnHttpMix.provider.dashscope.wanx.task;
...
public interface WanxAsyncTaskResult extends WanxAsyncTaskResultSucceedMixin, WanxAsyncTaskResultFailedMixin {
     ...
     * UNKNOWN：作业不存在或状态未知
     */
    default WanxTaskStatus getTaskStatus() {
        return WanxTaskStatus.valueOf(readString("output", "task_status"));
    }
     ...
     */
    default TaskMetrics getTaskMetrics() {
     ...
     */
    record TaskMetrics(Integer total, Integer succeeded, Integer failed) {
    }
