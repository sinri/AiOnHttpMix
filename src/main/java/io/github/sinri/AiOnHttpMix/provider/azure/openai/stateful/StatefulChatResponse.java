...
public interface StatefulChatResponse extends UnmodifiableJsonifiableEntity {
     ...
     */
    @Nullable
    default OpenAIErrorBase getError() {
     ...
     */
    default StatefulChatIncompleteDetails getIncompleteDetails() {
     ...
     */
    default StatefulChatReasoning getReasoning() {
     ...
     */
    @Nullable
    default StatefulChatToolChoice getToolChoice() {
