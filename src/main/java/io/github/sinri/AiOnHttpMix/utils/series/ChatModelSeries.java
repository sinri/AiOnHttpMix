 ...
 * @since 1.4.0
 */
public interface ChatModelSeries {
    QwenModelSeries qwen = new QwenModelSeries();
    ChatGPTModelSeries chatgpt = new ChatGPTModelSeries();
    DoubaoModelService doubao = new DoubaoModelService();
