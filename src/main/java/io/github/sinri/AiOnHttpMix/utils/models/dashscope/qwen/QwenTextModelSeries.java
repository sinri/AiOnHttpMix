 ...
 * @since 2.0.0
 */
public abstract class QwenTextModelSeries extends DashscopeModelSpecification
        implements TextModel {
    public final static String NAME_OF_MODEL_SERIES = "QwenTextModelSeries";
    ...
    public static QwenTextModelSeries model(String modelName) {
        return new QwenTextModelSeries() {
            @Override
